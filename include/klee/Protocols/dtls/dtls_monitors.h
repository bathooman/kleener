...
#define record_version_diff_test 110
#define ch0_handshake_version_diff_test 112
...
void ch0_version_diff_testing_server(RECORD *P,bool is_record_client_generated);
#endif // DTLS_MONITORS